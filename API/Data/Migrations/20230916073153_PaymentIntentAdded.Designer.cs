...
namespace API.Data.Migrations
{
    ...
    [Migration("20230916073153_PaymentIntentAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Entities.OrderAggregate.UserAdress", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("API.Entities.OrderAggregate.UserAdress", b =>
                {
                    b.HasOne("API.Entities.User", null)
                        .WithOne("Adress")
                        .HasForeignKey("API.Entities.OrderAggregate.UserAdress", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
